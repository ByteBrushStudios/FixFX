...
<Cards>
  <Card title="ESX" href="./esx">
    The most widely used framework for FiveM, providing a complete roleplay foundation.
  </Card>
  
  <Card title="QBCore" href="./qbcore">
    A modern, modular framework with extensive features for roleplay servers.
  </Card>
  
  <Card title="OverExtended" href="./overextended">
    A newer framework focused on performance and modern development practices.
  </Card>
</Cards>
