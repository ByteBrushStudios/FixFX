...
<StepList
  steps={[
    { title: "Create Database", description: "Set up MySQL/MariaDB with proper user permissions and character set" },
    { title: "Create Folder Structure", description: "Create [esx] and [standalone] folders in your resources directory" },
    { title: "Clone Core Resources", description: "Clone ESX core, framework, and essential resources from GitHub" },
    { title: "Install Database Connector", description: "Choose and install oxmysql or ghmattimysql" },
    { title: "Import Database", description: "Run SQL files to create necessary tables for all resources" },
    { title: "Configure Connections", description: "Set database credentials in config.lua and server.cfg" },
    { title: "Start Server", description: "Launch your FiveM server and verify all resources load correctly" }
  ]}
  title="ESX Legacy Installation Steps"
/>
...
<PropertyCard type="info" name="Database Configuration" description="The database connection in ESX is managed through the ox_lib library. Make sure your MySQL user has proper privileges and the connection string is correct." />
