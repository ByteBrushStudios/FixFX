...
<TroubleshootingCard title="Database Connection Problems" problem="Unable to connect to MySQL database" solution="Verify database credentials, check MySQL service is running, confirm connection string in server.cfg, check user permissions" />
