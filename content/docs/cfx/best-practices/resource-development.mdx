...
<StepList
  steps={[
    "Create root resource folder with descriptive name",
    "Organize code into client/, server/, and shared/ directories",
    "Create utility modules for reusable functions",
    "Set up fxmanifest.lua with proper dependencies",
  ]}
/>
...
<Callout type="warning">
  Always test your resources thoroughly in a development environment before
  deploying to production.
</Callout>

<Callout type="info">
  For more information about specific aspects of resource development, refer to
