...
<FeatureList
  features={[
    {
      title: "Debug Console",
      description: "Real-time server information and debugging capabilities",
      icon: "terminal",
    },
    {
      title: "Resource Debugger",
      description: "Track resource execution and identify performance issues",
      icon: "bug",
    },
    {
      title: "State Inspection",
      description: "Examine variable values and resource state in real-time",
      icon: "database",
    },
    {
      title: "Command Execution",
      description: "Execute debug commands directly in the console",
      icon: "terminal",
    },
  ]}
/>
...
<Callout type="info">
  Regular debugging helps identify and resolve issues before they become
  critical problems.
</Callout>

<Callout type="warning">
  Debug tools can impact server performance. Use appropriate levels and enable
  only when needed.
</Callout>
