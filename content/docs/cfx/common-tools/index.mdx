  ...
  features={[
    {
      ...
      description: "Track CPU usage, memory, and script execution times",
      icon: "monitor",
    },
    {
      title: "Profiler",
      description:
        "Analyze performance bottlenecks and function execution times",
      icon: "activity",
    },
    {
      title: "Network Tools",
      description: "Monitor latency, packet loss, and connection quality",
      icon: "globe",
    },
    {
      title: "Debug Tools",
      description: "Access server information and real-time debugging",
      icon: "bug",
    },
  ]}
/>
...
<Callout type="info">
  Remember to disable monitoring tools when not in use to minimize performance
  impact on your server.
</Callout>

<Callout type="warning">
  Always test tool configurations in a development environment before applying
  them to production.
</Callout>
