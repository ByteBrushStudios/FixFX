...
<FeatureList
  features={[
    {
      title: "CPU Usage Tracking",
      description: "Monitor percentage of CPU time used by each resource",
      icon: "activity",
    },
    {
      title: "Memory Monitoring",
      description: "Track memory usage per resource and identify memory leaks",
      icon: "database",
    },
    {
      title: "Script Execution Time",
      description: "Measure how long scripts take to execute",
      icon: "clock",
    },
    {
      title: "Network Usage",
      description: "Monitor network traffic per resource",
      icon: "globe",
    },
    {
      title: "Thread Performance",
      description: "Track active threads and thread execution times",
      icon: "terminal",
    },
  ]}
/>
...
<Callout type="warning">
  High monitoring intervals can impact server performance. Adjust based on your
  needs.
</Callout>
