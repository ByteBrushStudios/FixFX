...
<TroubleshootingCard
  title="Connection Configuration Error"
  symptoms={[
  ...
  solutions={[
    ...
    "Test connection using mysql client tool",
...
<PropertyCard
  ...
  value="10"
  description="Controls how many concurrent database connections can be maintained. Higher values allow more simultaneous queries but use more resources."
  type="info"
/>

<PropertyCard
  name="mysql_connection_timeout"
  value="10000"
  description="Timeout in milliseconds for establishing new database connections. Increase if connections are timing out."
  type="warning"
/>
...
<Callout type="warning">
  Always backup your database before making any configuration changes or running
  maintenance operations. Regular monitoring and maintenance are essential for
  optimal database performance.
</Callout>

<Callout type="info">
  For more information about database management, refer to the relevant sections
  in the documentation and server commands reference.
</Callout>
