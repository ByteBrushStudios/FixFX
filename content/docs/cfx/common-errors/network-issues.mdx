...
<CommandCard
  command="netgraph"
  description="Shows real-time network performance metrics including latency and packet loss"
/>
...
Check the [official FiveM documentation](https://docs.fivem.net/docs/server-manual/server-commands/) for current resource management options.
...
<Callout type="warning">
  Always monitor your network performance and implement proper error handling to
  prevent connection issues. Regular monitoring and maintenance are essential
  for optimal server performance.
</Callout>

<Callout type="info">
  For more information about network management, refer to the relevant sections
