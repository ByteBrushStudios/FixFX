...
<Callout type="info">
  For more information about client-related questions, refer to the [Client
  FAQ](https://docs.fivem.net/docs/support/client-faq/).
</Callout>
...
<Callout type="info">
  For more information about client issues, refer to the [Client
  Issues](https://docs.fivem.net/docs/support/client-issues/) documentation.
</Callout>
...
<Callout type="info">
  For more information about server management, refer to the [Server
  Issues](https://docs.fivem.net/docs/support/server-issues/) documentation.
</Callout>
...
<Callout type="info">
  For more information about server debugging, refer to the [Server
  Debugging](https://docs.fivem.net/docs/support/server-debug/) documentation.
</Callout>
...
<Callout type="info">
  For more information about bans, refer to the [Ban
  FAQ](https://docs.fivem.net/docs/support/ban-faq/).
</Callout>
...
<Callout type="info">
  For more information about resources, refer to the [Resource
  FAQ](https://docs.fivem.net/docs/support/resource-faq/).
</Callout>
...
<Callout type="warning">
  Always refer to the official FiveM documentation for the most up-to-date
  information. This guide is meant to provide a quick reference for common
  questions.
</Callout>
