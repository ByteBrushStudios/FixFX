...
<CheckList
  items={[
    "Use responsive design that works at any resolution",
    "Minimize file sizes for HTML, CSS, and JavaScript",
    "Implement proper error handling in JavaScript",
    "Test UI thoroughly before deploying to production",
    "Use CSS custom properties for easy theming",
    "Keep NUI callback processing minimal and efficient",
    "Validate all user input on both client and server",
    "Cache NUI frame data to reduce callback frequency",
  ]}
  variant="check"
/>
...
function updatePlayerDataDisplay() {
  ...
  document.getElementById("playerMoney").textContent =
