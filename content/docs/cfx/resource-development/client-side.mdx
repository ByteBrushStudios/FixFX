  ...
  steps={[
    {
      ...
      description: "Set up the basic client.lua file with event handlers and main thread"
    },
    {
    ...
    },
    {
      ...
      description: "Use debug tools to test functionality and optimize performance"
    }
  ]}
/>
