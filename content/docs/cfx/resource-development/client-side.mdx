...
<StepList
  title="Client Script Development Workflow"
  steps={[
    {
      title: "Create Script Structure",
      description:
        "Set up the basic client.lua file with event handlers and main thread",
    },
    {
      title: "Implement Player Management",
      description: "Handle player state, position, and vehicle information",
    },
    {
      title: "Add Event Listeners",
      description: "Register network events to receive data from server",
    },
    {
      title: "Create UI Elements",
      description: "Build NUI or in-game UI components for user interaction",
    },
    {
      title: "Test and Debug",
      description:
        "Use debug tools to test functionality and optimize performance",
    },
  ]}
/>
