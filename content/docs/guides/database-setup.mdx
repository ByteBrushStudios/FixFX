...
<StepList
  steps={[
    { title: "Download Database Software", description: "Choose and download MariaDB or MySQL from official sources" },
    { title: "Run Installer", description: "Execute the installer with appropriate options for your OS" },
    { title: "Configure Settings", description: "Set character set to UTF8MB4 and configure resource limits" },
    { title: "Secure Installation", description: "Set root password and remove anonymous/test accounts" },
    { title: "Create Databases", description: "Create databases and users for your FiveM resources" },
    { title: "Verify Connection", description: "Test connections from your FiveM server" },
    { title: "Enable Backups", description: "Configure automatic backups for data protection" }
  ]}
...
<ConfigBlock
  ...
  config={[
    { key: "character-set-server", value: "utf8mb4", description: "Unicode support for international characters" },
    { key: "collation-server", value: "utf8mb4_unicode_ci", description: "Proper collation for Unicode" },
    { key: "max_connections", value: "500", description: "Maximum concurrent database connections" },
    { key: "innodb_buffer_pool_size", value: "1G", description: "Cache size for frequently accessed data" }
  ]}
/>
