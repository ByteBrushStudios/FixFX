  ...
  steps={[
    {
      ...
      description:
        "Download the resource from its official source (GitHub, GitLab, or official repository)",
    },
    {
      title: "Extract Files",
      description:
        "Extract the ZIP file to your resources folder and rename if necessary to remove version numbers",
    },
    {
      title: "Verify Structure",
      description:
        "Ensure fxmanifest.lua exists at the root of the resource directory",
    },
    {
      title: "Configure Resource",
      description:
        "Edit config files and set appropriate options for your server",
    },
    {
      title: "Import Database",
      description:
        "If applicable, import SQL files to your database using MySQL commands",
    },
    {
      title: "Add to server.cfg",
      description: "Add 'ensure resource_name' to your server.cfg file",
    },
    {
      title: "Test & Restart",
      description:
        "Restart your server and verify the resource loads without errors",
    },
  ]}
