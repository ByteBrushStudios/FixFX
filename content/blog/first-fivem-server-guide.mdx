...
Before diving into technical setup, decide what type of server you want to create:

<FeatureList
  features={[
    {
      title: "Roleplay Server",
      description: "Character-driven immersive experiences",
    },
    {
      title: "Racing Server",
      description: "Competitive racing with custom tracks",
    },
    {
      title: "PvP/Combat Server",
      description: "Action-focused gameplay",
    },
    {
      title: "Creative/Building Server",
      description: "Sandbox construction experiences",
    },
    {
      title: "Mini-Game Hub",
      description: "Multiple game modes and activities",
    },
  ]}
  columns={2}
/>
...
<CheckList
  items={[
    "Define your target audience - Who is your server for?",
    "Identify unique features - What makes your server special?",
    "Plan resource allocation - Time and financial investment needed",
    "Assess technical skills - Lua scripting, database management, etc.",
    "Consider server hosting - Self-hosted vs managed hosting",
  ]}
  variant="check"
/>
...
<CheckList
  items={[
    "Pros: Complete control, no monthly fees, unlimited customization",
    "Cons: Technical expertise required, 24/7 internet needed, security responsibility",
    "Requires: Dedicated computer/VPS, static IP, 8GB+ RAM, fast internet",
  ]}
  variant="bullet"
/>
  ...
  features={[
    {
      title: "ZAP-Hosting",
      description:
        "€15-50/month - FiveM-optimized, official partner, easy setup",
    },
    {
      title: "Nodecraft",
      description: "$10-40/month - User-friendly interface, good performance",
    },
    {
      title: "xREALM",
      description: "$15-45/month - FiveM-specialized, reliable uptime",
    },
  ]}
  columns={3}
/>
...
_Need help with your FiveM server? Join our [Discord community](/discord) where experienced developers and server owners share knowledge and provide support._
