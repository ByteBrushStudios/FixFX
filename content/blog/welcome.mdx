...
import { CheckList, FeatureList, QuickLinks } from '@ui/components/mdx-components'
  ...
  features={[
    {
      ...
      description: "Detailed, up-to-date documentation for all aspects of FiveM development"
    },
    {
      title: "Community-Driven Content",
      description: "Contributions from experienced developers and community members"
    },
    {
      title: "Modern Search",
      description: "Advanced search functionality to quickly find relevant information"
    },
    {
  ...
  features={[
    {
      ...
      description: "Detailed guides for server setup, framework documentation, resource development tutorials, and best practices"
    },
    {
      title: "Troubleshooting Center",
      description: "Common error solutions, performance optimization guides, debugging techniques, and community-contributed fixes"
    },
    {
      title: "Development Resources",
      description: "Code examples and templates, API references, tool guides, and version compatibility information"
    },
    {
      title: "Community Integration",
      description: "Discord support, GitHub collaboration, community contributions, and regular updates"
    }
  ]}
  columns={2}
/>
