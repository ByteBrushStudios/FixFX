                ...
                <div className="space-y-6 p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Button
                        variant={
                          selectedGame === "gta5" ? "default" : "outline"
                        }
                        size="sm"
                        className={cn(
                          "flex-1",
                          selectedGame === "gta5" &&
                            "bg-[#5865F2] hover:bg-[#5865F2]/90 text-white border-none",
                        )}
                        onClick={() => {
                          onGameChange("gta5");
                      ...
                      <Button
                        variant={
                          selectedGame === "rdr3" ? "default" : "outline"
                        }
                        size="sm"
                        className={cn(
                          "flex-1",
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Button
                        variant={
                          selectedEnvironment === "all" ? "default" : "outline"
                        }
                        size="sm"
                        className={cn(
                          "flex-1",
