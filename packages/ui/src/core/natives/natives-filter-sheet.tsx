...
export function NativesFilterSheet({
  ...
  const clientCategories = relevantCategories.filter(
    (cat) => !serverCategories.includes(cat) && cat !== "CFX",
  );
              ...
              <div className="bg-gradient-to-br from-[#0F0B2B]/60 to-[#0F0B2B]/30 p-4 rounded-xl space-y-3 border border-[#5865F2]/10">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>
                      <strong className="text-white">Client</strong> - Player's
                      computer
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>
                      <strong className="text-white">Server</strong> - Game
                      server
                    </span>
                  </div>
                </div>
