...
export function NativesSidebar({
  ...
  const getRelevantCategories = () => {
    let baseCats: string[] = [];
    if (
      categoriesByGameAndEnv &&
      categoriesByGameAndEnv[game] &&
  ...
  const serverCategories = relevantCategories.filter(
    (cat) =>
      cat !== "CFX" &&
      (cat === "NETWORK" ||
        cat === "PLAYER" ||
  ...
  const clientCategories = relevantCategories.filter(
    (cat) => cat !== "CFX" && !serverCategories.includes(cat),
  );
            ...
            <div className="space-y-5 p-4">
              ...
              >
                <div className="bg-gradient-to-br from-[#0F0B2B]/80 to-[#0F0B2B]/40 rounded-xl p-4 border border-[#5865F2]/10">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    CitizenFX framework functions for client and server
                    scripting.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-1.5 max-h-[calc(100vh-32rem)] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-[#5865F2]/20 scrollbar-track-transparent">
                  ...
                  {/* Server Categories */}
                  {sortedServerCategories.length > 0 &&
                    environment !== "client" && (
                      <div className="mt-3 space-y-1.5">
                  ...
                  {/* Client Categories */}
                  {sortedClientCategories.length > 0 &&
                    environment !== "server" && (
                      <div className="mt-3 space-y-1.5">
                ...
                >
                  <div className="p-4 space-y-4 bg-gradient-to-b from-[#0F0B2B]/80 to-[#0F0B2B]/40">
                    <div className="space-y-3">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Natives are low-level functions provided by the
                        CitizenFX framework and game engines.
                      </p>
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            ...
                            <span>
                              <strong className="text-white">Shared</strong> -
                              Both environments
                            </span>
                          </div>
                        </div>
