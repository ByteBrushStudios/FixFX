    ...
    async (page = 1) => {
      try {
        ...
        const response = await fetch(
          `${API_URL}/api/artifacts/fetch?${params.toString()}`,
        );
        if (!response.ok) {
        ...
        const normalizedData = {
          data: data.data.map((artifact: any) => ({
            ...
            fullVersion:
              artifact.FullVersion || `${artifact.Version}-${artifact.Hash}`,
            hash: artifact.Hash,
            ...
            <div className="py-4 space-y-4">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {["recommended", "latest", "active", "deprecated", "eol"].map(
                    (statusOption) => (
                      <Button
                        key={statusOption}
                        variant={
                          supportStatusFilter === statusOption
                            ? "default"
                            : "outline"
                        }
                        className={cn(
                  ...
                  <Button
                    ...
                    className={cn(!supportStatusFilter && "bg-[#5865F2]")}
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Button
                    variant={
                      sortingOptions.sortBy === "date" ? "default" : "outline"
                    }
                    className={cn(
                      sortingOptions.sortBy === "date" && "bg-[#5865F2]",
                    )}
                    onClick={() =>
                      setSortingOptions({ ...sortingOptions, sortBy: "date" })
                    }
                  >
                    Release Date
                  </Button>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Button
                    variant={
                      sortingOptions.sortOrder === "asc" ? "default" : "outline"
                    }
                    className={cn(
                      sortingOptions.sortOrder === "asc" && "bg-[#5865F2]",
                    )}
                    onClick={() =>
                      setSortingOptions({ ...sortingOptions, sortOrder: "asc" })
                    }
                  >
                    Oldest First
                  </Button>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Button
                    ...
                    className={cn(includeEolState ? "bg-[#5865F2]" : "")}
                  >
              ...
              <div className="hidden md:flex items-center gap-2">
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleSearchChange}
                    className={cn(
                      "pl-8 w-64 bg-fd-background/50 focus-visible:ring-[#5865F2]",
                      search && "pr-8",
                    )}
                  />
                  {search && (
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="w-48 bg-fd-background/95 backdrop-blur-md p-2"
                  >
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1.5">
                        <div className="text-xs font-medium text-white mb-1 px-1.5">
                          Status
                        </div>
                        {[
                          "All",
                    ...
                    <div className="flex flex-col items-center justify-center p-12">
                      <div className="w-full max-w-md space-y-4">
                        ...
                        <Alert className="mt-4 bg-fd-background/30 border border-[#5865F2]/20">
                          ...
                          <AlertTitle className="text-[#5865F2]">
                            Loading Artifacts
                          </AlertTitle>
                          <AlertDescription className="text-sm text-muted-foreground">
                            <div className="space-y-2">
                              <p>
                                We're fetching the latest server artifacts from
                                the CFX Repository. This process involves:
                              </p>
                              <div className="space-y-1.5">
                                <div className="flex items-center gap-2">
                                  <div className="h-1.5 w-1.5 rounded-full bg-[#5865F2]/50 animate-pulse" />
                                  <span>
                                    Retrieving the latest build information
                                  </span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <div className="h-1.5 w-1.5 rounded-full bg-[#5865F2]/50 animate-pulse" />
                                  <span>
                                    Calculating support status for each version
                                  </span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <div className="h-1.5 w-1.5 rounded-full bg-[#5865F2]/50 animate-pulse" />
                                  <span>
                                    Determining recommended and latest builds
                                  </span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <div className="h-1.5 w-1.5 rounded-full bg-[#5865F2]/50 animate-pulse" />
                                  <span>
                                    Applying your selected filters and sorting
                                  </span>
                                </div>
                              </div>
                              <p className="text-xs text-muted-foreground/80">
                                This may take a few seconds as we ensure you get
                    ...
                    <div className="space-y-6">
                        ...
                        {(() => {
                          const recommendedArtifact = artifacts.data.find(
                            (artifact) =>
                              ...
                              artifact.supportStatus === "recommended",
                          );
                              ...
                              <Card className="group relative overflow-hidden border-green-500/30 bg-gradient-to-br from-green-500/5 via-transparent to-transparent hover:border-green-500/50 transition-all duration-300">
                                  ...
                                  <div className="flex items-start justify-between">
                                    <div className="space-y-1">
                                      ...
                                      <CardDescription className="text-muted-foreground">
                                        Best choice for production servers
                                      </CardDescription>
                                    </div>
                                    <TooltipProvider>
                                      <Tooltip>
                                ...
                                <CardContent className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 gap-3">
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                      ...
                                      <span>
                                        {formatDate(recommendedArtifact.date)}
                                      </span>
                                    </div>
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                    ...
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground col-span-2">
                                      ...
                                      <span className="font-mono text-xs">
                                        {recommendedArtifact.hash.substring(
                                          0,
                                          12,
                                        )}
                                      </span>
                                    ...
                                    >
                                      ...
                                      <AccordionContent>
                                        <div className="space-y-3 pt-2">
                                          ...
                                          <p className="text-xs text-muted-foreground">
                                            Use this version string in your
                                            Pterodactyl, Pelican, or similar
                                            hosting panel's egg configuration.
                                          </p>
                                        </div>
                                      </AccordionContent>
                                    </AccordionItem>
                                ...
                                <CardFooter>
                                  <Button
                                    ...
                                    onClick={() =>
                                      handleDownload(recommendedArtifact.url)
                                    }
                                  >
                                    <Download className="h-4 w-4 mr-2" />
                                    Download{" "}
                                    {recommendedArtifact.platform === "windows"
                                      ? "ZIP"
                                      : "TAR.XZ"}
                                  </Button>
                                </CardFooter>
                              ...
                              <Card className="group relative overflow-hidden border-blue-500/30 bg-gradient-to-br from-blue-500/5 via-transparent to-transparent hover:border-blue-500/50 transition-all duration-300">
                                ...
                                <CardContent className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 gap-3">
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                      <Calendar className="h-3.5 w-3.5" />
                                      <span>
                                        {formatDate(latestArtifact.date)}
                                      </span>
                                    </div>
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                      <HardDrive className="h-3.5 w-3.5" />
                                    ...
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground col-span-2">
                                      <Hash className="h-3.5 w-3.5" />
                                      <span className="font-mono text-xs">
                                        {latestArtifact.hash.substring(0, 12)}
                                      </span>
                                    </div>
                                  </div>
                                ...
                                <CardFooter>
                                  <Button
                                    ...
                                    onClick={() =>
                                      handleDownload(latestArtifact.url)
                                    }
                                  >
                                    <Download className="h-4 w-4 mr-2" />
                                    Download{" "}
                                    {latestArtifact.platform === "windows"
                                      ? "ZIP"
                                      : "TAR.XZ"}
                                  </Button>
                                </CardFooter>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                          <div className="p-3 rounded-xl bg-fd-muted/30 border border-fd-border text-center transition-all hover:bg-fd-muted/50">
                            ...
                            <p className="text-2xl font-bold">
                              {artifacts.metadata.stats?.total ??
                                artifacts.metadata.total}
                            </p>
                          </div>
                          <div className="p-3 rounded-xl bg-green-500/5 border border-green-500/20 text-center transition-all hover:bg-green-500/10">
                            ...
                            <p className="text-2xl font-bold text-green-500">
                              {artifacts.metadata.stats?.recommended ?? 0}
                            </p>
                          </div>
                          <div className="p-3 rounded-xl bg-blue-500/5 border border-blue-500/20 text-center transition-all hover:bg-blue-500/10">
                            ...
                            <p className="text-2xl font-bold text-blue-500">
                              {artifacts.metadata.stats?.latest ?? 0}
                            </p>
                          </div>
                          <div className="p-3 rounded-xl bg-cyan-500/5 border border-cyan-500/20 text-center transition-all hover:bg-cyan-500/10">
                            ...
                            <p className="text-2xl font-bold text-cyan-500">
                              {artifacts.metadata.stats?.active ?? 0}
                            </p>
                          </div>
                          <div className="p-3 rounded-xl bg-red-500/5 border border-red-500/20 text-center col-span-2 sm:col-span-1 transition-all hover:bg-red-500/10">
                            ...
                            <p className="text-2xl font-bold text-red-500">
                              {artifacts.metadata.stats?.eol ?? 0}
                            </p>
                          </div>
                        </div>
                        ...
                        {(search || supportStatusFilter || includeEolState) && (
                          <div className="flex flex-wrap items-center gap-2 text-sm mt-4 pt-4 border-t border-fd-border">
                            ...
                            {search && (
                              <Badge
                                variant="secondary"
                                className="flex items-center gap-1 bg-fd-muted/50 text-xs"
                              >
                                Search: {search}
                                <Button
                                  variant="ghost"
                      ...
                      <div className="space-y-3">
                        {artifacts.data.filter(
                          (artifact) => artifact.platform === platformKey,
                        ).length > 0 ? (
                          artifacts.data
                            .filter(
                              (artifact) => artifact.platform === platformKey,
                              ...
                              >
                                <div
                                  className={cn(
                                    ...
                                    artifact.supportStatus === "active" &&
                                      "border-cyan-500/20 hover:border-cyan-500/40",
                                    artifact.supportStatus === "deprecated" &&
                                      "border-amber-500/20 hover:border-amber-500/40",
                                    artifact.supportStatus === "eol" &&
                                    ...
                                    ![
                                      ...
                                      "deprecated",
                                      "eol",
                                    ].includes(artifact.supportStatus) &&
                                      "border-fd-border hover:border-[#5865F2]/40",
                                  )}
                                >
                      ...
                      {artifacts &&
                        ...
                        (() => {
                          const totalPages = Math.ceil(
                            artifacts.metadata.total / artifacts.metadata.limit,
                          );
                          const currentPageNum =
                            Math.floor(
                              artifacts.metadata.offset /
                                artifacts.metadata.limit,
                            ) + 1;
                          return totalPages > 1;
                        })() && (
