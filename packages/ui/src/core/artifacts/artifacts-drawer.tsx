...
export function ArtifactsDrawer({
  ...
  const [activeTab, setActiveTab] = useState<"navigation" | "platform">(
    "navigation",
  );
          ...
          <div className="flex items-center justify-between p-4 border-b border-[#5865F2]/10">
            ...
            >
              <TabsList className="bg-[#0F0B2B]/60 grid grid-cols-2 h-10 w-full rounded-xl p-1">
                <TabsTrigger
                  value="navigation"
                  className="rounded-lg data-[state=active]:bg-gradient-to-br data-[state=active]:from-[#5865F2] data-[state=active]:to-[#4752C4] data-[state=active]:text-white data-[state=active]:shadow-md"
                >
                  Navigation
                </TabsTrigger>
                <TabsTrigger
                  ...
                  <div className="text-xs text-muted-foreground space-y-2 leading-relaxed">
                    ...
                    <div className="space-y-1.5 mt-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          <strong className="text-red-400">EOL</strong> - No
                          longer supported
                        </span>
                      </div>
                    </div>
