...
try {
  ...
  if (lastUpdated < thirtyDaysAgo) {
    warnings.push('List was last updated more than 30 days ago. Consider running the scraper.');
  }
  ...
  console.log(`   Last updated: ${new Date(trustedHosts.lastUpdated).toLocaleString()}`);
