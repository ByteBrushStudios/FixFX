  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        <span style={{ color: "#f8fafc", fontWeight: "500" }}>FiveM</span>,{" "}
        <span style={{ color: "#f8fafc", fontWeight: "500" }}>RedM</span>, and
        the{" "}
        <span style={{ color: "#f8fafc", fontWeight: "500" }}>CitizenFX</span>{" "}
        ecosystem.
      </p>
