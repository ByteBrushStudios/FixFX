...
export const alt = "FixFX Chat - AI-Powered FiveM Assistant";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    >
      ...
      <div
        style={{
          ...
          height: "350px",
          background:
            "radial-gradient(circle, rgba(88, 101, 242, 0.25) 0%, transparent 70%)",
          borderRadius: "50%",
        }}
      />
      <div
      ...
      >
        ...
        <span style={{ color: "#5865f2", fontSize: "18px", fontWeight: "500" }}>
          Powered by AI
        </span>
      </div>
    </div>,
