...
const sections = [
  ...
  },
  {
    ...
    description:
      "Learn recommended practices for development and server management.",
      ...
      <div className="space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Explore our comprehensive documentation covering everything from
            basic concepts to advanced development techniques.
          </p>
        </div>
