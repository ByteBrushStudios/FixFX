...
function ArtifactsPageContent() {
  ...
  const initialPlatform =
    (searchParams.get("platform") as "windows" | "linux") || "windows";
  const initialSearch = searchParams.get("search") || "";
  const initialSortBy =
    (searchParams.get("sortBy") as "version" | "date") || "version";
  const initialSortOrder =
    (searchParams.get("sortOrder") as "asc" | "desc") || "desc";
  const initialStatus =
    (searchParams.get("status") as SupportStatus) || undefined;
  ...
  return (
    <div className="relative flex min-h-screen h-screen bg-background overflow-hidden">
      ...
      <div className="hidden md:flex w-full h-full">
        <ArtifactsSidebar platform={platform} onPlatformChange={setPlatform} />
